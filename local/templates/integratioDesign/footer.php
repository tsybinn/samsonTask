...
?>
	...
	array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/local/templates/integratioDesign/include/events.php"
	),
	false
);?>
<!--					<div class="sb_event">-->
...
<!--					</div>-->
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "PATH" => "/local/templates/integratioDesign/include/sale.php"
                        )
                    );?>
<!--					<div class="sb_action">-->
<!---->
...
<!--					</div>--><?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "COMPONENT_TEMPLATE" => ".default",
                            "EDIT_TEMPLATE" => "standard.php",
                            "PATH" => "/local/templates/integratioDesign/include/reviewed.php"
                        )
                    );?>
				...
				<div class="ft_contacts">
                    ...
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "COMPONENT_TEMPLATE" => ".default",
                            "EDIT_TEMPLATE" => "standard.php",
                            "PATH" => "/local/templates/integratioDesign/include/contact.php"
                        )
                    );?>
<!--					<p class="vcard">-->
<!--						<span class="adr">-->

...
<div id="feedback"><!-- hidden inline form -->
    ...
    <form id="f_contact" name="contact" enctype="multipart/form-data" method="post" action="#" method="post">
        ...
        <input type="text" id="FIO" name="f_name"><br>

        <label for="f_email">Описание</label><br>
        <input type="text" id="DESCR" name="f_email"><br>
...
<a href="#feedback" rel="nofollow" class="modalbox">Создать</a>
<?
///var_dump($arResult);
